...
<%doc> Kirby's original newsfeed form
...
<!--                <div class="form-row control-group row-fluid">
                ...
                -->
                  <div class="form-row control-group row-fluid">
                      <label class="control-label span3" for="default-textarea">Content</label>
                      <div class="controls span9">
                          <textarea name="content" rows="7" class="row-fluid" id="default-textarea"></textarea>
                      </div>
                  </div>
                  <!--
                  <div class="form-row control-group row-fluid">
