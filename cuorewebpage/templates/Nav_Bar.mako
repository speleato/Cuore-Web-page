            ...
            <ul id="sidebar_menu" class="navbar nav nav-list container full">
                ...
                <li class="accordion-group color_7"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse1"> <img src="img/menu_icons/forms.png"><span>Directory</span></a>
                    <ul id="collapse1" class="accordion-body collapse">
                        ...
                        <li><a href="/Directory">Groups</a></li>
                    </ul>
                ...
                <li class="color_13"> <a class="widgets" href="/IdeaCenter"> <img src="img/menu_icons/calendar.png"><span>Idea Center</span></a> </li>
                <li class="color_10"> <a class="widgets"data-parent="#sidebar_menu" href="/CMS"> <img src="img/menu_icons/maps.png"><span>CMS</span></a> </li>
                <li class="accordion-group color_12"> <a class="widgets" data-parent="#sidebar_menu" href="/Store"> <img src="img/menu_icons/tables.png"><span>Store</span></a> </li>
                <li class="color_24"> <a class="widgets"data-parent="#sidebar_menu" href="/Jobs"> <img src="img/menu_icons/grid.png"><span>Jobs</span></a> </li>
                <li class="accordion-group color_19"> <a class="widgets"data-parent="#sidebar_menu" href="/Support"> <img src="img/menu_icons/statistics.png"><span>Support</span></a> </li>
                <li class="color_8"> <a class="widgets"data-parent="#sidebar_menu" href="/Contact"> <img src="img/menu_icons/gallery.png"><span>Contact Us</span></a> </li>
                <li class="accordion-group color_25"> <a class="widgets" data-parent="#sidebar_menu" href="/Logout"> <img src="img/menu_icons/others.png"><span>Logout</span></a> </li>
            </ul>
