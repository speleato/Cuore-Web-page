...
%else:
    %if admin:
        <%include file="cuorewebpage:templates/settings_admin.mako"/>
    %elif not registered:
        <%include file="cuorewebpage:templates/registration_form.mako"/>
    %else:
        <%include file="cuorewebpage:templates/settings_form.mako"/>
    %endif
%endif
