...
<div id="main_container">
  <div class="row-fluid">
    ...
    <div class="span8">
    <div class="box color_3 title_big paint height=xxlarge">
        ...
        <div class="row-fluid fluid">
          <div class="span12">
            ...
            <div class="btn-toolbar pull-right">
              <div class="btn-group"> <a class="btn" href="${request.route_url('Newsfeed')}">View All</a> <a class="btn change_color_outside"><i class="paint_bucket"></i></a> </div>
            </div>
          </div> <!-- End .span12 -->
        </div> <!-- End .row-fluid -->
      </div> <!-- End .title -->
      ...
      <div class="content row-fluid" style="padding-top:115px;">
          <ul class="messages_layout">
              ...
              <% counter = 0 %>
              % for item in alerts:
                %if counter < EMAX and item['type'] == "post":
              <%
              post = item['node']
              ...
              <li class="span12 from_user left"> <a href="#" class="avatar"><img src="img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                      <div class="info"> <a class="name" href="/blog/post?URI=${post.getNode()._id}">${post.getName()}</a> <span class="author"><a href="#">@${owner}</a></span></div>
                      <div class="text"> ${post.getContent()} </div>
                      <div class="footer">
                          <span class="time">${post.getTime()}</span>
                          <div class="actions pull-right hidden-phone">
                              <ul class="pull-right">
                                  <li><a href="/blog/post?URI=${post.getNode()._id}"><i class=" gicon-share-alt icon-white"></i>Reply</a></li>
                                  <li><a href="/blog/post?URI=${post.getNode()._id}"><i class="gicon-comment"></i> ${len(post.getComments())} Comments</a></li>
<!--                              <li><a href="#"><i class=" gicon-share icon-white"></i>Share</a></li>
                ...
                %elif counter < EMAX and item['type'] == "event":
              <%
              event     = item['node']
              %>
