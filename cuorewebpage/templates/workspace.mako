...
<div id="main_container">
    ...
    <div class="span8">
      <div class="box paint color_18">
        ...
        <div class="content full">
          <table id="datatable_example" class="responsive table table-striped table-bordered table-hover full">
            <thead>
              <tr>
                <th class="jv no_sort"> Project</th>
                <th class="ue"> Description </th>
                <th class="ms no_sort "> Ongoing Tasks</th>
                <th class="Yy to_hide_phone"> % Complete </th>
              </tr>
            </thead>
            <tbody>
              <tr>
  ...
  <div class="row-fluid">
    ...
    <!-- End .span6 -->
    <div class="span6">
      <div class="box color_2 height_xbig">
        <div class="title row-fluid">
          <h4 class="pull-left"><span>Blog</span></h4>
          <div class="btn-toolbar pull-right ">
          ...
          <ul class="messages_layout">
            ...
            <li class="from_user left"> <a href="#" class="avatar"><img src="img/message_avatar2.png"/></a>
              <div class="message_wrap"> <span class="arrow"></span>
                <div class="info"> <a class="name" href="#">post.getOwner()</a> <span class="author"><a href="#">@celeste</a></span></div>
